             ...
             <div class="row">
              <div class=col-sm-4>
                   <span class="btn btn-primary" data-toggle="modal" data-target="#modalAgregaCategoria">
                       <span class="fa-solid fa-circle-plus"></span> Agregar Nueva Categoria
                   </span>
              </div>
            </div>
...
<!-- Modal -->
<div class="modal fade" id="modalAgregaCategoria" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden=" ">
...
<?php 
          include "footer.php";
 ?>
    <!-- Dependencia de categorias,todas las funciones de js  de categoria-->
